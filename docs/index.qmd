...
`simulate()`, in turn, calls `initialize()`, `get_action()`, `run_timestep()`, and `compute_outcome()`, so you don't need to implement it yourself:
...
The framework also provides helpful configurations for you:
