...
→ [Getting Started](guide/getting-started.qmd) — checklist of what to implement + minimal working example

→ [House Elevation Example](examples/house_elevation.qmd) — complete worked example with flood risk optimization
