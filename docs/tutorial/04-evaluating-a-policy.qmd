...
#| fig-cap: "Distribution of NPV damages across 1000 SOWs for 5-foot elevation"
#| code-fold: true
let
...
In the [next section](05-exploratory-modeling.qmd), we'll use the `explore()` function to systematically evaluate **all combinations** of policies and SOWs.
