...
In the DMDU literature, **exploratory modeling** means systematically running a model across a wide range of plausible assumptions to understand *where and why* a policy succeeds or fails.
...
let
    ...
    sc = scatter!(ax, discount_rates, mean_water_levels;
        color=costs, colormap=:RdYlGn_r, markersize=10, alpha=0.8)
