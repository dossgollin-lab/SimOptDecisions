...
# The framework calls get_action before this, so we receive the action directly
function SimOptDecisions.TimeStepping.run_timestep(
    ...
    construction_cost = t.t == 1 ? elevation_cost(action.elevation_ft, config.house_area_ft2, config.house_value) : 0.0
