...
```{julia}
# Construct policy from best parameters
best_policy = ElevationPolicy(opt_result.best_params)
println("Best policy found: elevation = $(round(best_policy.elevation_ft, digits=1)) ft")
println(
