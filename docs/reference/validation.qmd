...
SimOptDecisions can validate that your Scenario, Policy, and Outcome types use parameter wrappers (`ContinuousParameter`, `DiscreteParameter`, `CategoricalParameter`, or `TimeSeriesParameter`).
