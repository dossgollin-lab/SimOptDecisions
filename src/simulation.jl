...
function simulate(config::AbstractConfig, scenario::AbstractScenario, policy::AbstractPolicy, recorder::AbstractRecorder, rng::AbstractRNG)
...
simulate(config::AbstractConfig, scenario::AbstractScenario, policy::AbstractPolicy, rng::AbstractRNG) =
    simulate(config, scenario, policy, NoRecorder(), rng)

simulate(config::AbstractConfig, scenario::AbstractScenario, policy::AbstractPolicy, recorder::AbstractRecorder) =
    simulate(config, scenario, policy, recorder, default_rng())

simulate(config::AbstractConfig, scenario::AbstractScenario, policy::AbstractPolicy) =
...
function simulate_traced(config::AbstractConfig, scenario::AbstractScenario, policy::AbstractPolicy, rng::AbstractRNG)
...
simulate_traced(config::AbstractConfig, scenario::AbstractScenario, policy::AbstractPolicy) =
